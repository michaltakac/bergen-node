...
$y^{\prime\prime}(x)+6y^{\prime}(x)+8y(x)= e^{-2x}$.
...
$\displaystyle f(x,y)=\dfrac{1}{x+y}$ \\ 
\hspace*{1.4cm} v bode $T=\left[4,y_{0},\dfrac{1}{3}\right]$.
...
$\displaystyle f(x,y)=\ln(x+2y)$, 
bod $\displaystyle A=[-2, \, 2]$ 
a vektor $\displaystyle \vec{l}=\left(1, \, -1\right)$.
